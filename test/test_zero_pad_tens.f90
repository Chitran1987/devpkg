program test_seqn
    ...
    X = seq(st=-10.0_real64, en = 10.0_real64, len = 250)
    Y = seq(st = -5.0_real64, en = 5.0_real64, len = 125)

    ! Create the square lattice and write it
    tens = square_latt_sb(X = X, Y = Y, r_latt = 1.0_real64, A = 1.0_real64, sig = 0.15_real64)
